...
const testMes = [
  ...
  {
    "type": "ai",
    "content": "你好，我点的餐有一道菜根本没送过来！你们的服务也太不到位了吧，我已经等了很久。",
  }, // AI 消息
  {
    "type": "user",
    "content": "非常抱歉让您久等了，请问是哪道菜没有送到？我们立刻核实并尽快为您补上，真的很抱歉给您带来了不便。",
  }, // 用户回复
  {
    "type": "ai",
    "content": "我点了三道菜，但少了一份牛排。你们难道不核对订单吗？这种情况实在让人失望。",
  }, // AI 消息
  {
    "type": "user",
    "content": "真的非常抱歉，经过核实确实是我们的疏忽导致牛排未送达。我们马上为您补上，并为您提供免费甜品作为补偿。同时，您点的牛排我们会加急处理，确保您能尽快享用。再次抱歉给您带来的不便。",
  }, // 用户回复
  {
    "type": "ai",
    "content": "等了这么久，免费的甜品就能解决问题吗？我现在已经没有什么食欲了。你们的服务效率真让人怀疑。",
  }, // AI 消息
  {
    "type": "user",
    "content": "我们理解您的心情，延误确实让您的用餐体验受到了影响。为此，我们决定将您的整顿餐免单，并提供200元的代金券以表达我们的诚意。我们非常重视您的反馈，保证这种情况不会再发生。我们也希望您能够再次光临，见证我们的改善。",
  }, // 用户回复
  {
    "type": "ai",
    "content": "免单和代金券就够了吗？你们的服务这么差，让我觉得再来你们这里是个错误。我很怀疑你们能不能真的改善。",
  }, // AI 消息
  {
    "type": "user",
    "content": "我们对您的不满深感抱歉。为了进一步表示我们的诚意，我们将为您提供VIP卡，确保您下次可以享受更优质的服务体验。我们已经对服务流程进行了调整，所有订单会在出餐前再次确认，以避免任何遗漏。希望您能给我们一个机会，让我们重新赢得您的信任。",
  }, // 用户回复
  {
    "type": "ai",
    "content": "VIP卡倒是挺吸引人的，但我现在最担心的是你们能不能真的提升服务，避免再次出现这种问题。我可不想下次来还是遇到同样的事情。",
  }, // AI 消息
  {
    "type": "user",
    "content": "我们完全理解您的顾虑，您的反馈对我们非常重要。我们会将这次的情况作为重要的改进案例，并严格监督后续服务流程的改进。您每次用餐后都可以给我们直接反馈，我们会特别关注您的体验。再次对今天发生的一切表示深深的歉意，希望您能见证我们的进步。",
  }, // 用户回复
  {
    "type": "ai",
    "content": "好吧，希望你们这次说到做到。这次就算了，但下次再有问题我绝对不会轻易原谅。",
  }, // AI 消息
  {
    "type": "user",
    "content": "感谢您的宽容，我们会竭尽全力确保类似问题不再发生。期待您的再次光临，给我们机会为您提供更好的用餐体验。如果您有任何需求，随时联系我们，我们会第一时间为您服务。",
  } // 用户回复
]
];
